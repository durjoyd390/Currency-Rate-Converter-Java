...
public class Main {
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Currency Converter By Mr Das");
        frame.setSize(900, 500);
        frame.setLocation(200, 150);
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        JLabel headlineLabel = new JLabel("Currency Converter By Mr Das");
        headlineLabel.setFont(new Font("Arial", Font.BOLD, 24));
        frame.add(headlineLabel);
        headlineLabel.setBounds(280, 50, 500, 30); // Set position
        ...
        String[] messages1 = {
                "USD", "AFN", "ALL", "DZD", "AOA", "ARS", "AMD", "AWG", "AUD", "AZN", "BSD", "BHD", "BDT", "BBD", "BYR", "BEF", "BZD", "BMD", "BTN", "BTC", "BOB",
